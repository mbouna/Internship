...
public class Poste1_6 extends Agent {
...
protected void setup()
	{
	  	System.out.println("agent Poste 6 est deployé ");
		...
		{Workbook workbook = null;
			try {
				...
				Sheet sheet = workbook.getSheet(0);
						Cell a = sheet.getCell(i,25);
						Cell b = sheet.getCell(i,26);
						Cell c = sheet.getCell(i,27);
				...
				ACLMessage msg=receive();
				 if(msg!=null){//ACLMessage msg666 = new ACLMessage(ACLMessage.INFORM);
				 //msg666.addReceiver(new AID("Agent Manager", AID.ISLOCALNAME));
				// msg666.setContent("Courant dans le Poste 6 est : "+"       ph1="+a.getContents()+"   ph2="+b.getContents()+"  ph3="+c.getContents());
				// send(msg666);
					 if (  ((a1>60)&&(b1<=60)&&(c1<=60))||((a1<=60)&&(b1>60)&&(c1<=60))||((a1<=60)&&(b1<=60)&&(c1>60))  ){ 
							e6=1;
							ACLMessage etat6 = new ACLMessage(ACLMessage.INFORM);
							etat6.addReceiver(new AID("Agent Manager", AID.ISLOCALNAME));
							etat6.setContent("Poste6_"+e6+"");
